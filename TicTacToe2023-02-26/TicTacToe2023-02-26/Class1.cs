...
public class Player : IColour// : PlayerMove //Ärver Playermove pga få färg till errormeddelande och kunna addera wins/ties för BO3, BO5
{
    private string name;
    ...
    public string Color(string input)//Overridas från Colour för att få Errormeddelanden röda
    {
